...
Installer.prototype.computeLinked = function (cb) {
  ...
  asyncMap(this.differences, function (action, next) {
    ...
    var isReqByTop = pkg.package._requiredBy.some(function (name) { return name === '/' || name === '#DEV:/' })
    var isReqByUser = pkg.package._requiredBy.some(function (name) { return name === '#USER' })
